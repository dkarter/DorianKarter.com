...
define('EMAIL', 'jobs@doriankarter.com');
...
if (defined('EMAIL') && isset($_POST['contact_send'])) {
    ...
    if (isset($_POST['contact_email'])) {
        ...
        $email = 'unknown@doriankarter.com';
    }
...
MESSAGE;
    ...
    if ($status) {
        ...
        if ($status) {
            ...
            respond('Error! Cannot send mail. Please use jobs[at]doriankarter[.]com from your mail client.');
        }
    }
